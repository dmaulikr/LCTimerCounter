...
- (void)setType:(infoPanelType)type
{
    if (type == infoPanelTypeError)
    {
        ...
        self.thumbImage.image = [UIImage imageNamed:@"me.png"];
        self.detailLabel.textColor = [UIColor colorWithRed:0.f green:0.f blue:0.f alpha:1.f];
    }
    else if (type == infoPanelTypeInfo)
    {
        ...
        self.titleLabel.font = [UIFont boldSystemFontOfSize:14];
        self.detailLabel.font = [UIFont fontWithName:@"Tick" size:14];
        self.thumbImage.image = [UIImage imageNamed:@"me.png"];
        self.detailLabel.textColor = [UIColor colorWithRed:0.f green:0.f blue:0.f alpha:1.f];
    }
}
